...
public class LoseScreen implements Screen {
    ...
    public LoseScreen(Game game) {
        ...
        background = new Texture("loseback.png");

        Button.buttonWidth = 380;
        Button.buttonHeight = 130;

        TryAgain = new Button("tryagain.png");
        TryAgain.getButtonSprite().setPosition(215, 200);

        MainMenu = new Button("mainmenubutton.png");
        MainMenu.getButtonSprite().setPosition(215, 360);
