...
//
    ...
    public void createBoxes(){
        ...
        FixtureDef platformProperty = new FixtureDef();
        platformProperty.density = 100f;
        platformProperty.friction = 3500f;
        platformProperty.shape = rectangle1;
        platform.createFixture(platformProperty);
    ...
    public void renderBoxes(){
        ...
        if (launched && loadedBirdNum < birdBodies.size() - 1) {
            ...
            loadedBirdNum++;
            System.out.println("Loaded num:" + loadedBirdNum);
            // Load next bird
            loadedBody = birdBodies.get(loadedBirdNum);
            loadedSprite = birdSprites.get(loadedBirdNum);
        ...
        System.out.println("Birdsize" + birdBodies.size());
        System.out.println("LoadSize"+loadedBirdNum);
        if(loadedBirdNum >= birdBodies.size()-1 && launched && loadedBody.getLinearVelocity().isZero()){
